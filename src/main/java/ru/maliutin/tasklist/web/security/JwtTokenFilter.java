...
/**
 * Собственный фильтр проводящий аутентификацию пользователя по передаваемому токену.
 */
@AllArgsConstructor // Аннотация lombok - добавляет конструктор со всеми полями
public class JwtTokenFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        /*
            Получаем токен из запроса пользователя. servletRequest приводим к типу HttpServletRequest,
            используя метод getHeader() получаем заголовок запроса, именуемый как Authorization
         */
