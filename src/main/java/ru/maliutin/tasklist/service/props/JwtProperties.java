...
@ConfigurationProperties(prefix = "security.jwt")  // Аннотация указывающая откуда брать данные для полей класса: application.yaml -> security -> jwt (названия полей совпадают с ключами в файле)
